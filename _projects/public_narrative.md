...
description: We propose a novel computational framework for computational analysis of Public Narratives and demonstrate the potential of LLM-assisted annotation for scalable narrative analysis.
...
## Demo
Check out our interactive data visualization below or [click here](https://maggatronn.github.io/pn_visualization/) to view in a separate tab.
<div class="row justify-content-center">
