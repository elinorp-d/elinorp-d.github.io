---
layout: distill
title: I have a lot of plants (Part 4)
date: 2025-11-16
description: A brief history of Elinor and her plants 
tags: plants history
categories: plants
thumbnail: assets/img/plants/part4/livingroom_oct2021.png
featured: true
...
toc:
  ...
  - name: Fall 2021
    subsections: 
        - name: star wars pothos
        - name: hoya compacta
---

If you haven't seen [part 3](/blog/2024/plants-part-3/), go check it out :)
...
Remember Star Wars Pothos that I'd propagated on May 4th, 2020? I used command strips to pin the vines on the wall above my desk in Sept 2021, and by December it was absolutely thriving!<d-footnote>Aroids love to climb, so this shouldn't be surprising</d-footnote>
...
<div class="row justify-content-center">
    <div class="col-6 col-lg-3">
        {% include figure.liquid loading="eager" path="assets/img/plants/part4/hoyacompacta/nov2021.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            November 2021: the slightest hint of new growth.
        </div>
    </div>
    <div class="col-6 col-lg-3">
        {% include figure.liquid loading="eager" path="assets/img/plants/part4/hoyacompacta/dec2021.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            December 2021: a funky leaf at the base, and a new leaf baby at the middle! 
        </div>
    </div>
    <div class="col-6 col-lg-3">
        {% include figure.liquid loading="eager" path="assets/img/plants/part4/hoyacompacta/mar2022.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            Early March 2022: two new leaves finally growing from the top.
        </div>
    </div>
    <div class="col-6 col-lg-3">
        {% include figure.liquid loading="eager" path="assets/img/plants/part4/hoyacompacta/endmar2022.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
