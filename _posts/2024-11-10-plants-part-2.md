...
If you haven't seen part 1, [go check it out!](/blog/2024/plants-part-1/)
...
<div class="row justify-content-center">
    <div class="col-6 col-sm-4">
        {% include figure.liquid loading="eager" path="assets/img/plants/part2/moving.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            Plants ready for moving.
        </div>
    </div>
    <div class="col-8">
        {% include figure.liquid loading="eager" path="assets/img/plants/part2/poutine.png" class="img-fluid rounded z-depth-1" zoomable=true %}
        <div class="caption">
            Poutine on the first night in our new apartment!
        </div>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-6 col-lg-5">
        {% include figure.liquid loading="eager" path="assets/img/plants/part2/my_room_left.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-6 col-lg-5">
        {% include figure.liquid loading="eager" path="assets/img/plants/part2/my_room_right.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
